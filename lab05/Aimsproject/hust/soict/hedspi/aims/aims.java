package lab05.Aimsproject.hust.soict.hedspi.aims;
...
public class aims {
    ...
    public static void viewStore(Scanner aims)
            throws NonExistingItemException, PlayerException, LimitExceededException, CartFullException {
    ...
    public static void seeCurrentCart(Scanner aims) throws NonExistingItemException, PlayerException {
        cartMenu();
        while (true) {
            System.out.println("Enter your option:"); // Add this prompt
            int option = aims.nextInt();
    ...
    public static void updateStore(Scanner aims) throws DupplicatedItemException, NonExistingItemException {
        while (true) {
    ...
    public static void addMediaCart(Scanner aims) throws LimitExceededException, CartFullException {
        System.out.println("Please enter the media's title: ");
        String title = aims.nextLine();
        int found = findIndex(title, store);
        if (found == -1) {
        ...
        while (true) {
            ...
            switch (option) {
                case 1:
                    ...
                    return (ArrayList<Media>) cart.getItemsInCart();
                case 2:
    ...
    public static void removeMediaCart(Scanner aims) throws NonExistingItemException {
    ...
    // main
    public static void main(String[] args) throws DupplicatedItemException, LimitExceededException, CartFullException,
            NonExistingItemException, PlayerException {
